...
#         if type(inputImgData) is np.ndarray:
#             inputImgData = cv2.cvtColor(inputImgData, cv2.COLOR_BGR2GRAY)
#         else:
#             inputImgData = cv2.cvtColor(inputImgData.numpy(), cv2.COLOR_BGR2GRAY)
        
#     # WARNING: Assuming square image patches
#     if inputImgData.shape[1] < 193:
#         inputImgData = cv2.resize(inputImgData, (194,194))
    ...
    feats = get_patches_test_features(inputImgData[...,0], patch_size)
